...
class TelefonoFijo {
    ...
    public function obtenerTelefonosPorCompania(){
        ...
        try {
            ...
            if (!$rs)
                throw new Exception("Error al consultar fijo: ".  mysql_error());
    ...
    public function obtenerTelefonosPorPersona() {
        ...
        ,numero 
        FROM 
        tb_telefonofijopersona WHERE tb_personacontacto_id = $this->_tb_personacontacto_id";
        ...
        try {
            ...
            $rs = mysql_query($query, $cn);
            if (!$rs)
                throw new Exception("Error al consultar___: ".  mysql_error());
