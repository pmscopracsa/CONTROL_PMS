...
try {
    ...
    $query = "SELECT 
            ...
            LEFT JOIN tb_comuntfijo tf ON pc.id = tf.tb_personacontactocomun_id
            LEFT JOIN tb_comuntmobile tm ON pc.id = tm.tb_personacontactocomun_id
            LEFT JOIN tb_comuntnextel tn ON pc.id = tn.tb_personacontactocomun_id
