...
<html>
    <head>
        ...
        $(document).ready(function() {
            ...
            /*
             * EDITAR OTRA COMPANIA
             */
            $("#btneditarOtraCompania").click(function() {
                if ($("#btneditarOtraCompania").val() === "Deseo editar otra compania") {
                    $("#otraBusqueda").fadeIn("slow", function () {
                        $("#btneditarOtraCompania").attr("value","Cancelar");
                    });
                } else {
                    $("#otraBusqueda").fadeOut("slow", function () {
                        $("#btneditarOtraCompania").attr("value","Deseo editar otra compania");
                         $.ajax({
                            type:"GET",
                            dataType:"html",
                            data:{
    ...
    <body class="fondo">
        ...
        <div id="main">
            ...
            <input type="button" id="btneditarOtraCompania" value="Deseo editar otra compania"/>
            
            
            <div id="otraBusqueda" style="display: none">
