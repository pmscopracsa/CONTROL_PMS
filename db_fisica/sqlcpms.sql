...
--
-- Servidor: localhost
-- Tiempo de generación: 06-09-2012 a las 23:18:02
...
(6, 'COPRACSA AIO', '20388197804', 'COPRACSA AIO.', '777', 'Actividad', 1, '555', 'OBSERVACION DE PRUEBA PARA ESTA EMPRESA', 'copracsa@copracsa.com', 'http://www.copracsa.com', 1, 1),
...
) ENGINE=InnoDB  DEFAULT CHARSET=latin1 COMMENT='Direccion de la compania contacto' AUTO_INCREMENT=11 ;
...
) ENGINE=InnoDB  DEFAULT CHARSET=latin1 COMMENT='Una compania puede tener n giros' AUTO_INCREMENT=23 ;
...
CREATE TABLE `tb_personacontacto` (
  ...
  KEY `tb_departamento_id` (`tb_departamento_id`),
  KEY `tb_distrito_id` (`tb_distrito_id`)
) ENGINE=InnoDB  DEFAULT CHARSET=latin1 COMMENT='contacto' AUTO_INCREMENT=2278 ;
...
(1, 1, '501', 'KARLA PALMA SAVEDRA', 'AGENTE VENDEDOR', '777', 'Testing', 'kpalma@corp2torres.com', 'http://www.yahoo.com', 1, 1227, 'Direccion 111', 177, 3, 1240),
