...
$rlistadist->set_id($_REQUEST['nombrelista']);
$res = $rlistadist->s_buscarListaDistribucionPorId();
          ...
          for ($i=0;$i<count($contactos);$i++) {
              if($i%2 != 0) {
                  echo'<tr id="tr_contacto">
                    <td>
                    <input type="text" id="txtContacto" class="inputext" size="45" name="giro" value="'.
                    $contactos[$i]
                    .'" READONLY/></td>
